...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        # создание кнопки добавление контакта
        ...
        self.edit_img = tk.PhotoImage(file='Project/img/update.png')
        ...
        self.del_img = tk.PhotoImage(file='Project/img/delete.png')
        ...
        # создание кнопки обновление таблицы
...
class Child(tk.Toplevel):
    ...
    def init_child(self):
        self.title('Добавление дочернего контакта')
